...
export default function HomePage() {
  ...
  const name = profile?.name || 'Team Member';
    const primary = 'purple-700'; // adjust to 8a1ccf in tailwind.config if needed
 ...
 return (
    <div className="relative min-h-screen bg-gradient-to-br from-purple-50 to-white py-20 px-4 overflow-hidden">
      ...
      {/* Decorative smooth blob */}
      <div className="pointer-events-none absolute top-24 right-0 w-72 h-72 transform translate-x-1/4 -translate-y-1/4">
        <svg viewBox="0 0 600 600" className="w-full h-full">
          <path fill="#8a1ccf10" d="M421.3,349.2Q374,448.4,278.7,467.5Q183.4,486.6,121.8,412.2Q60.1,337.8,92.2,237.3Q124.2,136.8,217.1,101.7Q310.1,66.6,390.8,122.3Q471.5,178.1,447.1,273.6Q422.6,369.1,421.3,349.2Z" />
        </svg>
      </div>
          ...
          {buttons
            ...
            .map(btn => (
              ...
              >
                ...
                <h2 className="text-xl font-semibold text-[#8a1ccf] group-hover:text-[#6a13a0] mb-2">{btn.label}</h2>
